 ...
 */
$config['APIUsername'] = $config['Sandbox'] ? 'info_api1.pretastyler.com' : 'PRODUCTION_USERNAME_GOES_HERE';
$config['APIPassword'] = $config['Sandbox'] ? '8MY4WWTUNPY7RZQW' : 'PRODUCTION_PASSWORD_GOES_HERE';
$config['APISignature'] = $config['Sandbox'] ? 'ASa5NqpopLly.BPwaX6PHo5JMs15Ab3m.Wu0UQa.RSlCVTJOH6icO8-K' : 'PRODUCTION_SIGNATURE_GOES_HERE';
 ...
 */
$config['DeveloperEmailAccount'] = 'estyle@taic.com.au';
