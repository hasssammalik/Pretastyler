...
*/
	...
	*/
	$config['security']['static_salt'] = 'pas-stasalt';
	...
	*/
	...
	$config['email']['site_title'] = "Prêt à Styler";
	
	// Reply email shown as 'from' header on emails.
	$config['email']['reply_email'] = "no-reply@pretastyler.com";
	...
	*/
	$config['email']['email_template_activate'] = 'activate_account.php';
	
	/**
	 * 'Forgot Password' email template.
	 * Default: 'forgot_password.tpl.php'
	*/
	$config['email']['email_template_forgot_password'] = 'forgot_password.php';

	/**
	 * 'Forgot Password Complete' email template.
	 * Default: 'new_password.tpl.php'
	*/
	$config['email']['email_template_forgot_password_complete'] = 'new_password.php';

	/**
	 * 'Update Email' email template.
	 * Default: 'update_email_address.tpl.php'
	*/
	$config['email']['email_template_update_email'] = 'update_email_address.php';
