				...
				<div id="register-form" style="display:none;">
					...
					<p>Sign up as a member and gain your own fashion mall filled with clothes and accessories specifically selected to suit your body.</p>
						<fieldset>
							...
							<div class="row">
								<label>Password:</label>
								<div class="icon-lock"><input type="password" id="menu_mall_register_password" placeholder="Password" name="password" required="required"></div>
							</div>
							<div class="row">
								<label>Confirm password:</label>
								<div class="icon-lock"><input type="password" id="menu_mall_register_rpassword" placeholder="Confirm password" name="confirm-password" required="required"></div>
							</div>
