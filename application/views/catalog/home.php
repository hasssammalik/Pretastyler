			...
			<div class="wid100">
				...
				<script type="text/javascript">
					...
					$(function(){
						...
						var bodyratioimage = [ 
            '<div id="talkbubble"><div class="slider-image"><img src="/images/profileSetup/body ratio/balanced.png" /></div><span>You have a long body and short legs.<br>Weight gain is first experienced at your bottom, hips and thighs.<br>You have a low waistline.<br>Bend your elbow 90% to the floor: you are a Short Legged and Long Bodied if your waist sits below your bent elbow.<br>Use the vertical calculator if you are unsure.</span></div>',
						'<div id="talkbubble"><div class="slider-image"><img src="/images/profileSetup/body ratio/longlegged.png" /></div><span>Your torso is equal in length to your legs.<br>The fullest part of your bottom protrudes at approximately half your height.<br>Weight gain is first experienced between your bust and hipline.<br>Bend your elbow 90% to the floor: you are a Balanced Body if you bent elbow in at the same position as your waist.<br>Use the vertical calculator if you are unsure.</span></div>',
						'<div id="talkbubble"><div class="slider-image"><img src="/images/profileSetup/body ratio/shortlegged.png" /></div><span>Your legs are longer than your body.<br>Your torso is short and your waistline feels/is high.<br>Weight gain is first experienced at your midriff, stomach and high on the back of your hips.<br>Bend your elbow 90% to the floor: you are a Long Legged and Short Bodied if your waist is above your bent elbow.<br>Use the vertical calculator if you are unsure.</span></div>',
												];
						var bustimage = 
						[ 
