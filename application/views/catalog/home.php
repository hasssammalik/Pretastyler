			...
			<div class="wid100">
				...
				<script type="text/javascript">
					...
					$(function(){
						...
						'<div id="talkbubble" class="doubleline"><div class="slider-image"><img src="/images/profileSetup/body shape/features_-11.png" /></div><span>You are larger above the waist than below<br>You are widest across your bustline<br>Your armpits are wider than the widest part of your hipline (when viewed from the front).<br>You are smaller below waist than below</span></div>',
						'<div id="talkbubble"><div class="slider-image"><img src="/images/profileSetup/body shape/features_-12.png" /></div><span>Your bust, waist and hipline are close to or the same in width.<br>Your waist is undefined<br>Your have a wide rib cage.</span></div>',
						'<div id="talkbubble"><div class="slider-image"><img src="/images/profileSetup/body shape/features_-13.png" /></div><span> You are larger below the waist than above<br>You have a well-defined waist<br>You have a narrow lower rib cage<br>Your armpits are narrower than the widest part of your hipline (when viewed from the front).</span></div>',
						...
						var bodyratioimage = [ 
            '<div id="talkbubble"><div class="slider-image"><img src="/images/profileSetup/body ratio/featues-10.png" /></div><span>Your torso is equal in length to your legs.<br>The fullest part of your bottom protrudes at approximately half your height.<br>Weight gain is first experienced between your bust and hipline.<br>Bend your elbow 90% to the floor: you are a Balanced Body if you bent elbow in at the same position as your waist.<br>Use the vertical calculator if you are unsure.</span></div>',
						'<div id="talkbubble"><div class="slider-image"><img src="/images/profileSetup/body ratio/featues-09.png" /></div><span>Your legs are longer than your body.<br>Your torso is short and your waistline feels/is high.<br>Weight gain is first experienced at your midriff, stomach and high on the back of your hips.<br>Bend your elbow 90% to the floor: you are a Long Legged and Short Bodied if your waist is above your bent elbow.<br>Use the vertical calculator if you are unsure.</span></div>',
						'<div id="talkbubble"><div class="slider-image"><img src="/images/profileSetup/body ratio/featues-11.png" /></div><span>You have a long body and short legs.<br>Weight gain is first experienced at your bottom, hips and thighs.<br>You have a low waistline.<br>Bend your elbow 90% to the floor: you are a Short Legged and Long Bodied if your waist sits below your bent elbow.<br>Use the vertical calculator if you are unsure.</span></div>',
												];
						var bustimage = 
						[ 
						...
						var buildimage = 
						[ 
						'<div id="talkbubble" class="med-width"><div class="slider-image"><img src="/images/profileSetup/build/features_-16.png" /></div><span>You have a petite frame.<br> You are likely to be short and small boned.</span></div>',
						'<div id="talkbubble" class="med-width"><div class="slider-image"><img src="/images/profileSetup/build/features_-17.png" /></div><span>Your frame is between small and large</span></div>',
						'<div id="talkbubble" class="med-width"><div class="slider-image"><img src="/images/profileSetup/build/features_-18.png" /></div><span>Your frame is large.<br>You are likely to be tall and large boned. </span></div>' 
						];
