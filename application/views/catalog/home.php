	...
	<div class="frontWrap">
		...
		<section class="role-element container wid60 preta-tooltip" id="the-product">
            ...
            '<div id="talkbubble"><div class="slider-image"><img src="/images/profileSetup/body ratio/balanced.png" /></div><span>Your torso is equal in length to your legs.<br>The fullest part of your bottom protrudes at approximately half your height.<br>Weight gain is first experienced between your bust and hipline.<br>Bend your elbow 90% to the floor: you are a Balanced Body if you bent elbow in at the same position as your waist.<br>Use the vertical calculator if you are unsure.</span></div>',
						...
						var buildimage = 
						[ 
						'<div id="talkbubble"><div class="slider-image"><img src="/images/profileSetup/build/features_-16.png" /></div><span>You have a petite frame.<br> You are likely to be short and small boned.</span></div>',
						'<div id="talkbubble"><div class="slider-image"><img src="/images/profileSetup/build/features_-17.png" /></div><span>Your frame is between small and large</span></div>',
						'<div id="talkbubble"><div class="slider-image"><img src="/images/profileSetup/build/features_-18.png" /></div><span>Your frame is large.<br>You are likely to be tall and large boned. </span></div>' 
						];
