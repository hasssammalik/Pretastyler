					...
					<div class="galleryAreaWrap notLoggedIn newpanelDesign">
						...
						<div class="galleryArea itemidentification panelcontentSecond" garment_id="<?php print ( !empty( $garment['garment_id'] ) ? $garment['garment_id'] : '' ) ?>">
							...
							?>" class="button buy" target="_blank">BUY / LEARN MORE</a></li>
										...
										<li class=""><a class="mousehand button other <?php if ($this->flexi_auth->is_logged_in()){?>favorite-click-product-page <?php if( !empty($garment['favorite'])) { print ($garment['favorite'] == 1)?' bkpinkycolor':''; }?> <?php } else{ ?> login_alert_user<?php } ?>">ADD TO WISHLIST</a></li>
										<ul>
										</div>
