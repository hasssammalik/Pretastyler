			...
			<div class="wid100">
				...
				<script type="text/javascript">
					...
					$(function(){
						...
						var shouldersimage = [ 
						'<div id="talkbubble"><div class="slider-image"><img src="/images/profileSetup/shoulder/features_-24.png" /></div><ul><li>Your shoulders have a definite slope from the base of your neck to</li><li> the tip of your shoulder. Shoulder straps will tend to slip off your shoulders..</li></ul></div>',
						'<div id="talkbubble"><div class="slider-image"><img src="/images/profileSetup/shoulder/features_-25.png" /></div><ul><li>Your shoulders have a slight slope.</li></ul></div>',
						'<div id="talkbubble"><div class="slider-image"><img src="/images/profileSetup/shoulder/features_-26.png" /></div>Your shoulders are broad and square with almost no slope<ul><li></li></ul></div>' 
						];
