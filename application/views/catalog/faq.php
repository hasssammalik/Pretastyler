		...
		<div class="faqs">
			...
			<div class="tab-links">
				...
				<div style="padding:10px 50px;">
					<ul>
						<li><a href="#q2a" class="i">a. How Do I Sign Up and What's Required?</a></li>
						<li><a href="#q2b" class="i">b. What's in the sneaky fine print, where's the catch?</a></li>
						<li><a href="#q2c" class="i">c. Is There a Free Version?</a></li>
						<li><a href="#q2d" class="i">d. Free Trials</a></li>
						<li><a href="#q2e" class="i">e. Updating Your Details</a></li>
						<li><a href="#q2f" class="i">f. Deleting Your Account</a></li>
					</ul>
				</div>
