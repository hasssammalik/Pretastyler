			...
			<div class="rightSide<?php print ($initial_data['last_one']?' last-one':'') ?>" garment_id="<?php print $garment['garment_id'] ?>">
				...
				<?php //for admin comments
					if ($this->flexi_auth->in_group(array('Administrators'))){ ?>
						<div>Uploaded by <?php print $user_name ?>(<a href="/admin/garment/user/<?php print $garment['import_user_id'] ?>.html" target="_blank">See Her Garments</a>, <a href="/admin/user/view/<?php $garment['import_user_id'] ?>.html" target="_blank">See Her Info</a>)</div>
