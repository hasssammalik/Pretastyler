	...
	<div class="imgWrap">
		...
		<div style="margin-top: 0px;">
			<span style = "height: 324px;">
				<a class="imgcontainer" href="/product/<?php print $row['garment_id'].'-'.url_title($row['name']).'.html' ?>">
			...
			<a href="/product/<?php print $row['garment_id'].'-'.url_title($row['name']).'.html' ?>" class="zoom bottomleftimage-showPink" target="_blank" title="Large View/Product details">
				<img src="/images/icons-25-info-pink.png" class="imageiconinfo-pink bottomleftimage-mall" style="display:none;">
