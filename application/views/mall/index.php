				...
				<?php if ($this->flexi_auth->is_logged_in()){ ?>
					<div class="col widfulled">
						...
						<div class="QuickRating search-quick-rating quick-star sectionTogglediv" id="quick-rating-search">
							...
							<span class="hoverStars starclick mousehand lowclassstar" data-val="1" title="Avoid" data-newtooltip="Avoid items with low percentage matches">☆<br><span class="star-visible">1</span>
							</span>

							<span class="hoverStars starclick mousehand lowclassstar" data-val="2" title="Maybe" data-newtooltip="Risky items with med-low percentage matches">☆<br><span class="star-visible">2</span>
							</span>
							
							<span class="hoverStars starclick mousehand lowclassstar" data-val="3" title="OK" data-newtooltip="OK items with med-high percentage matches">☆<br><span class="star-visible">3</span>
							</span>
							
							<span class="hoverStars starclick mousehand" data-val="4" title="Good" data-newtooltip="Good items with high percentage matches">☆<br><span class="star-visible">4</span>
							</span>
							
							<span class="hoverStars starclick mousehand active" data-val="5" title="Great" data-newtooltip="Great items with your highest percentage matches">☆<br><span class="star-visible">5</span>
							</span>
